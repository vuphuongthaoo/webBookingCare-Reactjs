...
class UserRedux extends Component {
  ...
  handleSaveUser = () => {
    ...
    if (action === CRUD_ACTIONS.CREATE) {
      ...
      this.props.createNewUser({
        ...
        phonenumber: this.state.phomeNumber,
  ...
  handleEditUserFromParent = (user) => {
    console.log("vuthao check handle edit user from parent: ", user);
    this.setState({
      email: user.email,
      password: "HARDCODE",
  ...
  render() {
    ...
    return (
      <div className="user-redux-container">
        <div className="title">Trang Booking Care</div>
            ...
            <div className="row">
              ...
              <div className="col-3">
                ...
                <input
                  ...
                  value={phomeNumber}
                  onChange={(event) => {
                    this.onChangeInput(event, "phomeNumber");
                  }}
                />
              </div>
              <div className="col-9">
